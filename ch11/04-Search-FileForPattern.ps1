...
Select-String '```powershell' $HOME/Documents/code/github/powershell/cheatsheets/*.md -Context 2, 2 |
    Select-Object Path, LineNumber, @{ Name = "Before"; Expression = { $PsItem.Context.PreContext -join "`n" } }, @{ Name = "After"; Expression = { $PsItem.Context.PostContext -join "`n" } } |
...
Select-String 'command' $HOME/Documents/code/github/powershell/cheatsheets/*.md -Exclude '*chapter-01.md' |
    Group-Object Path |
